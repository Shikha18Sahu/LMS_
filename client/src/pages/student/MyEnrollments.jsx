        ...
        <tbody className='text-gray-700'>
          {enrolledCourses.map((course, index)=>(
            <tr key={index} className='border-b border-gray-500/20'>
              <td className='md:px-4 pl-2 md:pl-4 py-3 totaflex items-center space-x-3'>
              ...
              <td className='px-4 py-3 max-sm:text-right'>
                <button className='px-3 sm:px-4 y-1.5 sm:py-2 bg-blue-600 max-sm:text-xs text-white' onClick={()=> navigate('/player/' + course._id)}>

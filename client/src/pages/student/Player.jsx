...
const extractYoutubeId = (url) => {
  ...
  const handleRate = async (value)=>{
    try {
      const token = await getToken()
      const { data } = await axios.post(backendUrl + '/api/user/add-rating', {courseId, rating: value}, { headers: {Authorization: `Bearer ${token}`}})
                            ...
                            <li key={i} className='flex items-start gap-2 py-1'>
                              ...
                              <div className= 'flex gap-2'>
                                ...
                                onClick={()=> {
                                  ...
                                  setPlayerData({
                                    ...lecture, chapter: index + 1, lecture: i + 1,lectureId: lecture.lectureId
                                  } )
                                }}
